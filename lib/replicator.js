...
function assign(replicant, value) {
	...
	emitToClients(replicant, 'replicant:assignment', {
		name: replicant.name,
...
function applyOperations(replicant, operations) {
	...
	emitToClients(replicant, 'replicant:operations', {
		name: replicant.name,
		namespace: replicant.namespace,
		revision: replicant.revision,
		operations
 ...
 * @param replicant {object} - The replicant.
 * @param eventName {string} - The name of the event to emit.
 * @param data {*} - The data to emit with the event.
 */
function emitToClients(replicant, eventName, data) {
	const roomName = `replicant:${replicant.namespace}:${replicant.name}`;

	log.replicants('emitting %s to %s:', eventName, roomName, data);
